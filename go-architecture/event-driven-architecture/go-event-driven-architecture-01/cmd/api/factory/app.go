...
import (
	...
	orderController "github.com/JimySheepman/event-driven-golang/internal/order/application/controller"
	orderUsecase "github.com/JimySheepman/event-driven-golang/internal/order/application/usecase"
	orderEvent "github.com/JimySheepman/event-driven-golang/internal/order/domain/event"
	userController "github.com/JimySheepman/event-driven-golang/internal/user/application/controller"
	userUsecase "github.com/JimySheepman/event-driven-golang/internal/user/application/usecase"
	userEvent "github.com/JimySheepman/event-driven-golang/internal/user/domain/event"
	"github.com/JimySheepman/event-driven-golang/pkg/queue"
)
