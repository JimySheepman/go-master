...
import (
	...
	"go-transactions/adapter/api/handler"
	"go-transactions/adapter/api/middleware"
	"go-transactions/adapter/presenter"
	"go-transactions/adapter/repository"
	"go-transactions/infrastructure/database"
	"go-transactions/infrastructure/logger"
	"go-transactions/infrastructure/router"
