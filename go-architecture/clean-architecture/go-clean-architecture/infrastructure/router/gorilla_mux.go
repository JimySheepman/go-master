...
import (
	...
	"go-clean-architecture/adapter/api/action"
	"go-clean-architecture/adapter/api/middleware"
	"go-clean-architecture/adapter/logger"
	"go-clean-architecture/adapter/presenter"
	"go-clean-architecture/adapter/repository"
	"go-clean-architecture/adapter/validator"
